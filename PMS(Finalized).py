...
def Base_Page():
    ...
    icon=PhotoImage(file="JU-Logo.png")
    ...
    bg_image = PhotoImage(file="jecrc.png")  # Add your background image file here
    bg_label = Label(root, image=bg_image)
    bg_label.place(x=0, y=0, relwidth=1, relheight=1)  # Place it to cover the entire window
...
# Empty Laber at Column 1
    ...
    icon=PhotoImage(file="JU-LogoDetails.png")
